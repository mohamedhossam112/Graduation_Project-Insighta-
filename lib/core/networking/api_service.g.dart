...
class _ApiService implements ApiService {
  _ApiService(this._dio, {this.baseUrl, this.errorLogger}) {
    baseUrl ??= 'https://insigtha.nabbra.org/api/';
  }
  ...
  Future<ResetPasswordResponseBody> resetPassword(
    ...
    final _options = _setStreamType<ResetPasswordResponseBody>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  @override
  Future<TherapyResponse> getTherapist() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<TherapyResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'therapists?page=1&per_page=10',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late TherapyResponse _value;
    try {
      _value = TherapyResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<AvatarResponse> uploadAvatar(File file) async {
    ...
    _data.fields.add(MapEntry('avatar', jsonEncode(file)));
